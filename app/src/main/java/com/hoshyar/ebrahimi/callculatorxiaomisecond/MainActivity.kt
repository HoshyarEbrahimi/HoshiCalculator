package com.hoshyar.ebrahimi.callculatorxiaomisecond
import android.os.Bundle
import android.view.ViewTreeObserver
import android.widget.Toast
import androidx.appcompat.app.AppCompatActivity
import com.hoshyar.ebrahimi.callculatorxiaomisecond.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun onOperatorClicked() {
        ...
        binding.btnAC.setOnClickListener {
            binding.txtExpression.text = null
    ...
    private fun onNumberClicked() {
        ...
        binding.btnMosavi.setOnClickListener {
            ...
            //try catch for fix this error -> (if user used two invalid chars forExample (2++2))
            try {
    ...
    private fun appendText(newText: String) {
        //delete txtExpression after one expression
        ...
        //make txtExpression horizontaly
